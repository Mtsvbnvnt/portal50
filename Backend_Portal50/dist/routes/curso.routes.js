 ...
 */
router.get('/', curso_controller_1.getCursos);
/**
 * @swagger
 * /api/cursos/{cursoId}:
 *   get:
 ...
 */
router.get('/:cursoId', curso_controller_1.getCursoById);
/**
 * @swagger
 ...
 */
router.post('/:cursoId/agendar', curso_controller_1.agendarClase);
/**
 * @swagger
 ...
 */
router.post('/:cursoId/upload-video', upload_middleware_1.uploadCurso.single('videoCurso'), curso_controller_1.uploadVideoCurso);
/**
 * @swagger
 * /api/cursos:
 *   post:
 ...
 */
router.get('/usuario/:usuarioId', curso_controller_1.getCursosPorUsuario);
